...
def test_register_required_ui(page, cleanup_customer):
    ...
    customer_response = CustomersClient().get_by_email(customer.email)
    print(customer_response)
    assert customer_response.firstname == customer.first_name
...
def test_register_optionals_ui(page, cleanup_customer):
...
def test_register_required_api(cleanup_customer):
    customer = CustomerFactory().create_required_api()

    customer_response = CustomersClient().create_customer(customer)

    cleanup_customer["email"] = customer.email

    saved_customer = CustomersClient().get_by_email(customer.email)
...
def test_register_full_api(cleanup_customer):
...
def test_register_valid_name_fields(field_name, valid_value, cleanup_customer):
    customer = CustomerFactory().create_required_api()

    setattr(customer, field_name, valid_value)
    CustomersClient().create_customer(customer)
...
def test_register_invalid_name_fields(field_name, invalid_value, cleanup_customer):
    customer = CustomerFactory().create_required_api()
...
def test_register_valid_email_field(valid_value, cleanup_customer):
    customer = CustomerFactory().create_required_api()
...
def test_register_invalid_email_field(invalid_value, cleanup_customer):
    customer = CustomerFactory().create_required_api()
...
def test_register_valid_password_field(valid_value, cleanup_customer):
    customer = CustomerFactory().create_required_api()
...
def test_register_invalid_password_field(invalid_value, cleanup_customer):
    customer = CustomerFactory().create_required_api()
...
def test_register_valid_groups(groups, default_group, cleanup_customer):
    customer = CustomerFactory().create_required_api()
...
def test_register_invalid_groups(groups, default_group, cleanup_customer):
    customer = CustomerFactory().create_required_api()
    customer.groupIds = groups
    customer.defaultGroupId = default_group
