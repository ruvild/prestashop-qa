...
- 🚧 **Аутентификация / Вход в систему** — *В процессе / Запланировано*
...
В процессе разработки был выявлен ряд дефектов, которые были отправлены в официальный [репозиторий PrestaShop](https://github.com/PrestaShop/PrestaShop). Соответствующие тесты сохранены в данном проекте как регрессионные тесты с использованием `pytest.mark.xfail` там, где это уместно.
...
* 🐛 [#42132](https://github.com/PrestaShop/PrestaShop/issues/42132) — Admin API — Несогласованная обработка пробельных символов
